<%@ Page Title="" Language="C#" MasterPageFile="~/employee/EmpMasterPage.master" AutoEventWireup="true" CodeFile="Inbox.aspx.cs" Inherits="employee_Inbox" %>
            ...
            <td class="style8" colspan="2">
              <asp:Panel ID="Panel1" runat="server" Width="100%" Height="350px" ScrollBars="Vertical">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    DataSourceID="SqlDataGetMsg" ForeColor="#333333" GridLines="None" Width="80%">
